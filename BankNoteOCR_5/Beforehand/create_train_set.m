...
train_set=mat2cell(character,42,[24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24]);
%{
train_set1 = mat2cell( [two five seven J W Z],42,[24 24 24 24 24 24] );
train_set2 = mat2cell( [three five C G S U W X Y],42,[24 24 24 24 24 24 24 24 24] );
train_set3 = mat2cell( [zero A O],42,[24 24 24] );

save ('Mat\train_set1.mat','train_set1');
save ('Mat\train_set2.mat','train_set2');
save ('Mat\train_set3.mat','train_set3');
%}
    
save ('Mat\train_set','train_set')
clear all
